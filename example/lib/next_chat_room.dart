...
class NextChatRoom extends StatefulWidget {
  const NextChatRoom({
    Key? key,
    required this.title,
  }) : super(key: key);
  ...
  @override
  State<NextChatRoom> createState() => _NextChatRoomState();
}

class _NextChatRoomState extends State<NextChatRoom> {
  List<String> events = [];
  List<Chat> chats = [];
